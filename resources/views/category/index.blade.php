        ...
        <div class="row bg-dark ">
            <div class="col-lg-12 bg-dark py-3 ">
                <div class="text-center mb-2">
                    <a href="{{ route('category.create') }} " class="btn btn-info">Create New Categories</a>
                </div>
                            ...
                            <tbody>
                                @forelse ($categoies as $item)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('category.destroy',$item->id) }}"><i class="fa-solid fa-trash text-danger "></i></a></td>
                                    </tr>
                                @empty
                                    <h1>No Data</h1>
                                @endforelse
