    ...
    <div class="container col-md-7 mt-3 bg-dark py-3">
        ...
        <form class="row g-3" action="{{ route('category.update',$category->id) }}" method="POST">
            ...
            <div class="col-md-12">
                ...
                <input type="text" id="title" value="{{$category->title}}"  name="title" class="form-control bg-dark text-white"
                    placeholder="Title">
            </div>
            <div class="col-md-12">
                <label for="description" class="form-label text-light">Enter Description</label>
                <input type="text" id="description" value="{{$category->description}}" name="description" class="form-control bg-dark text-white"
